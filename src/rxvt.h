...
#define mmc_none_parent_window 1
/* unfortunately, even the parent window is "dangerous": if I enlarge that window,
   the new area is filled, before the VT window fills it-> flicker!  */
